    ...
    if (c7==0) ac=3;
        if (ac!=4)
            ...
            if (table=='=')
                ...
                else if (first && table>=48 && table<=57){
                 buf1=buf1*10+(table-48);
                }
                else if (second && table>=48 && table<=56){
                 buf2=buf2*10+(table-48);
                }
                else if (table=='c'){
                 lcd_clear();
                 first=1;
